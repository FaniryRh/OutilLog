...
class Add59ed99579f26dRelationshipsToAssetsHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('assets_histories', function(Blueprint $table) {
            if (!Schema::hasColumn('assets_histories', 'asset_id')) {
                ...
                $table->foreign('assigned_user_id', '83911_59ed911fd4fd4')->references('id')->on('personnel_du_bngrcs')->onDelete('cascade');
                }
