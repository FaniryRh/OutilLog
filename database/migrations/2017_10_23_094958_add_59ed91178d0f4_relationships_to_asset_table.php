...
class Add59ed91178d0f4RelationshipsToAssetTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('assets', function(Blueprint $table) {
            if (!Schema::hasColumn('assets', 'category_id')) {
                ...
                $table->foreign('assigned_user_id', '83910_59ed91165e575')->references('id')->on('users')->onDelete('cascade');
                }
