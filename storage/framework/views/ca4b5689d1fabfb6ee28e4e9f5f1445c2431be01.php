<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::model($status_sortie, ['method' => 'PUT', 'route' => ['admin.status_sorties.update', $status_sortie->id]]); ?>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    <?php echo Form::label('nom', trans('quickadmin.status-sortie.fields.nom').'*', ['class' => 'control-label']); ?>
