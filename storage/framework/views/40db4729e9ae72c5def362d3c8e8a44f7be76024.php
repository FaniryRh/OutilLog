...
<?php $__env->startSection('content'); ?>
    ...
    <p>
        ...
        <a href="<?php echo e(route('admin.entrees.create')); ?>" class="btn btn-info fa fa-arrow-circle-down" style="float: right; margin-left: 10px;"> <!-- <?php echo app('translator')->getFromJson('quickadmin.qa_add_new'); ?> -->Effectuer Entrée</a>
        <a href="<?php echo e(route('admin.sorties.create')); ?>" class="btn btn-danger fa fa-arrow-circle-up" style="float: right;"> <!-- <?php echo app('translator')->getFromJson('quickadmin.qa_add_new'); ?> -->Effectuer Sortie</a>
