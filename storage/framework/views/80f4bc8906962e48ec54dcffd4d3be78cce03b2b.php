...
<?php $__env->startSection('content'); ?>
    ...
    <p>
        <a href="<?php echo e(route('admin.missions.create')); ?>" class="btn btn-success"><!-- <?php echo app('translator')->getFromJson('quickadmin.qa_add_new'); ?> -->Nouvelle mission</a>
                    ...
                    <?php if(count($missions) > 0): ?>
                        <?php $__currentLoopData = $missions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-entry-id="<?php echo e($mission->id); ?>">
                                ...
                                <td field-key='objet' style="color: red; font-style: bolder;"><?php echo e($mission->objet); ?></td>
