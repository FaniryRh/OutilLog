        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <?php echo Form::select('materiel_id[]', $materiel_ids, old('materiel_id') ? old('materiel_id') : $mission->materiel_id->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']); ?>
            ...
            <div class="" style="visibility: hidden; width: 1px; height: 1px;">
                <div class="" style="visibility: hidden; width: 1px; height: 1px;">
                 ...
                 <div class="" style="visibility: hidden; width: 1px; height: 1px;">
                    <?php echo Form::label('multiple_piece_jointe', trans('quickadmin.missions.fields.multiple-piece-jointe').'', ['class' => '']); ?>
                    ...
                    <div class=""  style="visibility: hidden; width: 1px; height: 1px;">
                        ...
                        <div class="progress-bar"  style="visibility: hidden; width: 0px; height: 0px;">&nbsp;</div>

                        <div class="" style="visibility: hidden; width: 1px; height: 1px;">
                            <?php $__currentLoopData = $mission->getMedia('multiple_piece_jointe'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <p class="form-group" style="visibility: hidden; width: 1px; height: 1px;">
                                    ...
                                    <input type="hidden" name="multiple_piece_jointe_id[]" value="<?php echo e($media->id); ?>">
                                </p>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    <?php if($errors->has('multiple_piece_jointe')): ?>
                        <p class="help-block" style="visibility: hidden; width: 1px; height: 1px;">
                ...
                <div class="">
                    ...
                    <?php echo Form::text('progression', old('progression'), ['class' => 'form-control', 'placeholder' => '']); ?>
