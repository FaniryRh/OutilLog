<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::open(['method' => 'POST', 'route' => ['admin.oms.store'], 'files' => true,]); ?>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::select('prise_en_charge[]', $prise_en_charges, old('prise_en_charge'), ['class' => 'form-control select2', 'multiple' => 'multiple']); ?>
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    <?php echo Form::label('etat_id', trans('Statut OM').'', ['class' => 'control-label']); ?>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 form-group">
                    <?php echo Form::label('etat_rapport_de_mission_id', trans('Statut rapport').'', ['class' => 'control-label']); ?>
