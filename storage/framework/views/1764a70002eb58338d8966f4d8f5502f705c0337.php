<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <!-- <?php echo app('translator')->getFromJson('quickadmin.qa_view'); ?> --><?php echo e($assets_category->title); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;"><?php echo app('translator')->getFromJson('quickadmin.assets-categories.fields.title'); ?></th>
...
<li role="presentation" class="active"><a href="#assets" aria-controls="assets" role="tab" data-toggle="tab">Matériels</a></li>
</ul>
...
<?php echo Form::open(array(
        ...
        <?php endif; ?>
            ...
            <a href="<?php echo e(route('admin.assets_categories.index')); ?>" class="btn btn-default"><?php echo app('translator')->getFromJson('quickadmin.qa_back_to_list'); ?></a>
        </div>
    </div>
