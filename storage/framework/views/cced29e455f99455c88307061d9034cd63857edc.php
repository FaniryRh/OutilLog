<?php $__env->startSection('content'); ?>
    <h3 class="page-title"><!-- <?php echo app('translator')->getFromJson('quickadmin.contacts.title'); ?> -->Contact</h3>
    
    <?php echo Form::model($contact, ['method' => 'PUT', 'route' => ['admin.contacts.update', $contact->id]]); ?>
