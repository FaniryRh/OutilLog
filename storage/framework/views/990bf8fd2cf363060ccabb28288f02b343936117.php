<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::open(['method' => 'POST', 'route' => ['admin.statut_personnels.store']]); ?>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    <?php echo Form::label('nom', trans('quickadmin.statut-personnel.fields.nom').'*', ['class' => 'control-label']); ?>
