<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::open(['method' => 'POST', 'route' => ['admin.contact_companies.store'], 'files' => true,]); ?>


    <div class="panel panel-primary">
        <div class="panel-heading">
            <!-- <?php echo app('translator')->getFromJson('quickadmin.qa_create'); ?> -->Nouvelle organisme
        </div>
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="contacts-region">
                    <?php $__currentLoopData = old('contacts_regions', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="groupe-sectoriel">
                    <?php $__currentLoopData = old('liste_groupe_sectoriels', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
