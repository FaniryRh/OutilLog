...
<style>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <!-- <?php echo app('translator')->getFromJson('quickadmin.qa_view'); ?> --><?php echo e($personnel_du_bngrc->nom_prenom); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;"><?php echo app('translator')->getFromJson('quickadmin.personnel-du-bngrc.fields.tel'); ?></th>
                            <td field-key='tel'><?php echo e($personnel_du_bngrc->tel); ?></td>
                        </tr>
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;"><?php echo app('translator')->getFromJson('quickadmin.personnel-du-bngrc.fields.tel2'); ?></th>
                        ...
                        <tr>
                            ...
                            <td field-key='statut' style="background-color: <?= $color ?>; color: white;"><?php echo e(isset($personnel_du_bngrc->statut->nom) ? $personnel_du_bngrc->statut->nom : ''); ?></td>
                        </tr>
                        <tr style="visibility: hidden; width: 1px; height: 1px; display: none;" >
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('personnel_du_bngrc_edit')): ?>
                                    <a href="<?php echo e(route('admin.personnel_du_bngrcs.edit',[$personnel_du_bngrc->id])); ?>" class="btn btn-info"><?php echo app('translator')->getFromJson('quickadmin.qa_edit'); ?></a>
                                    <?php endif; ?>
                </div>
