<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::model($sortie, ['method' => 'PUT', 'route' => ['admin.sorties.update', $sortie->id]]); ?>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <?php echo Form::hidden('location_latitude', $sortie->location_latitude , ['id' => 'location-latitude']); ?>

                    <?php echo Form::hidden('location_longitude', $sortie->location_longitude , ['id' => 'location-longitude']); ?>
