            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;"><?php echo app('translator')->getFromJson('quickadmin.liste-stock.fields.photo'); ?></th>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('liste_stock_edit')): ?>
                                    <a href="<?php echo e(route('admin.liste_stocks.edit',[$liste_stock->id])); ?>" class="btn btn-info fa fa-edit"> <?php echo app('translator')->getFromJson('quickadmin.qa_edit'); ?></a>
                                    <?php endif; ?>
                </div>
            </div><!-- Nav tabs --></br>
        ...
        <?php if(count($sorties) > 0): ?>
            <?php $__currentLoopData = $sorties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sorty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr data-entry-id="<?php echo e($sorty->id); ?>">
                                ...
                                <td field-key='quantite'><?php echo e($sorty->quantite); ?> <?php echo e($sorty->unite); ?></td>
        ...
        <?php if(count($inventaires) > 0): ?>
            <?php $__currentLoopData = $inventaires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inventaire): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr data-entry-id="<?php echo e($inventaire->id); ?>">
                                ...
                                <td field-key='quantite'><?php echo e($inventaire->quantite); ?> <?php echo e($inventaire->unite); ?></td>
