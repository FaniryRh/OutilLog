...
<style>
    ...
    <?php echo Form::open(['method' => 'POST', 'route' => ['admin.assets.store'], 'files' => true,]); ?>


    <div class="panel panel-primary">
        <div class="panel-heading" style="width: auto; height: auto;">
            <p style="font-size: 20px;"><strong>Nouveau matériel</strong></p>
        </div>
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-xs-6 form-group">
                    <?php echo Form::label('photo1', trans('Photo 1').'', ['class' => 'control-label']); ?>
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    <?php echo Form::label('title', trans('Désignation').'*', ['class' => 'control-label']); ?>
                ...
                <div class="col-xs-6 form-group">
                    <?php echo Form::label('photo2', trans('Photo 2').'', ['class' => 'control-label']); ?>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 form-group">
                    <?php echo Form::label('photo3', trans('Photo 3').'', ['class' => 'control-label']); ?>
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    <?php echo Form::label('date_acquisition', trans('Date d\'aquisition ').'', ['class' => 'control-label']); ?>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 form-group" style="height: 60px;">
                    <?php echo Form::label('notes', trans('quickadmin.assets.fields.notes').'', ['class' => 'control-label']); ?>

                    <?php echo Form::textarea('notes', old('notes'), ['class' => 'form-control ', 'placeholder' => '', 'style' => 'height : 50px;']); ?>
            ...
            <div class="col-xs-12 box box-warning" id="map-canvas"></div></br>
