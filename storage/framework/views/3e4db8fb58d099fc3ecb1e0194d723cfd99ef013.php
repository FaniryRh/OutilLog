            ...
            <div class="col-md-6">
                ...
                <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <div class="progress progress-sm active">
                            <div class="progress-bar progress-bar-default progress-bar-striped" role="progressbar" aria-valuenow= "" aria-valuemin="0" aria-valuemax="100" style="width: <?= $pourcentage_encours ?>%">
                        ...
                        <div class="progress progress-sm active">
                            <div class="progress-bar progress-bar-default progress-bar-striped" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100" style="width: <?= $pourcentage_enattente ?>%">
                        ...
                        <div class="progress progress-sm active">
                            <div class="progress-bar progress-bar-default progress-bar-striped" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100" style="width: <?= $pourcentage_terminee ?>%">
                        ...
                        <div class="progress progress-sm active">
                            <div class="progress-bar progress-bar-default progress-bar-striped" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100" style="width: <?= $pourcentage_annulee ?>%">
            ...
            <div class="col-md-6">
                ...
                <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <div class="progress progress-sm active">
                            <div class="progress-bar progress-bar-default progress-bar-striped" role="progressbar" aria-valuenow= "" aria-valuemin="0" aria-valuemax="100" style="width: <?= $pourcentage_task_encours ?>%">
                                <span class="sr-only"><?= $pourcentage_encours ?>%</span>
                            </div>
                        </div>
                        ...
                        <div class="progress progress-sm active">
                            <div class="progress-bar progress-bar-default progress-bar-striped" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100" style="width: <?= $pourcentage_task_enattente ?>%">
                                <span class="sr-only"><?= $pourcentage_enattente ?>%</span>
                            </div>
                        </div>
                        ...
                        <div class="progress progress-sm active">
                            <div class="progress-bar progress-bar-default progress-bar-striped" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100" style="width: <?= $pourcentage_task_terminee ?>%">
                                <span class="sr-only"><?= $pourcentage_terminee ?>%</span>
                            </div>
                        </div>
                        ...
                        <div class="progress progress-sm active">
                            <div class="progress-bar progress-bar-default progress-bar-striped" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="100" style="width: <?= $pourcentage_task_annulee ?>%">
                              <span class="sr-only"><?= $pourcentage_annulee ?>%</span>
                            </div>
                        </div>
