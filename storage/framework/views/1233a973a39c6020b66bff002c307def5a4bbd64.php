 ...
 <style>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <?php echo e(isset($inventaire->mission->objet) ? $inventaire->mission->objet : ''); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;"><?php echo app('translator')->getFromJson('quickadmin.inventaire.fields.materiel-id'); ?></th>
    ...
    <script>
      ...
      '<div id="siteNotice">'+
      '</div>'+
      '<h2>'+'<?php echo e($inventaire->objet); ?>'+'</h3>'+
