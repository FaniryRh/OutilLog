...
<?php $__env->startSection('content'); ?>
    ...
    <p>
        <a href="<?php echo e(route('admin.liste_stocks.create')); ?>" class="btn btn-success">Nouveau stock</a>
        <a href="<?php echo e(route('admin.entrees.create')); ?>" class="btn btn-default">Entrée</a>
        <a href="<?php echo e(route('admin.sorties.create')); ?>" class="btn btn-default">Sortie</a>
    </p>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <!-- <?php echo app('translator')->getFromJson('quickadmin.qa_list'); ?> --> Liste stock
        </div>
