...
<?php $__env->startSection('content'); ?>
    ...
    <p>
        <a href="<?php echo e(route('admin.personnel_du_bngrcs.create')); ?>" class="btn btn-success"><!-- <?php echo app('translator')->getFromJson('quickadmin.qa_add_new'); ?> -->Nouveau Personnel</a>
                    ...
                    <?php if(count($personnel_du_bngrcs) > 0): ?>
                        <?php $__currentLoopData = $personnel_du_bngrcs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $personnel_du_bngrc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-entry-id="<?php echo e($personnel_du_bngrc->id); ?>">
                                ...
                                <td field-key='statut'><span   class="badge bg-<?= $color ?>"  ><?php echo e(isset($personnel_du_bngrc->statut->nom) ? $personnel_du_bngrc->statut->nom : ''); ?></span></td>
