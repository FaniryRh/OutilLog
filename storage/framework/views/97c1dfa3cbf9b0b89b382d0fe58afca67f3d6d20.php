<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading" style="width: auto; height: auto;">
            <p style="font-size: 20px;"><strong>Modifier</strong></p>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    <?php echo Form::label('date_acquisition', trans('quickadmin.assets.fields.date-acquisition').'', ['class' => 'control-label']); ?>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 form-group" style="height: 60px;">
                    ...
                    <?php echo Form::textarea('notes', old('notes'), ['class' => 'form-control ', 'placeholder' => '' , 'style' => 'height : 60px;']); ?>
