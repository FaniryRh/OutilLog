...
<style>
    ...
    <?php echo Form::open(['method' => 'POST', 'route' => ['admin.personnel_du_bngrcs.store'], 'files' => true,]); ?>


    <div class="panel panel-primary">
        <div class="panel-heading">
            <!-- <?php echo app('translator')->getFromJson('quickadmin.qa_create'); ?> -->Ajout Personnel
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::select('competence_formation[]', $competence_formations, old('competence_formation'), ['class' => 'form-control select2', 'multiple' => 'multiple']); ?>
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::select('capacites[]', $capacites, old('capacites'), ['class' => 'form-control select2', 'multiple' => 'multiple']); ?>
