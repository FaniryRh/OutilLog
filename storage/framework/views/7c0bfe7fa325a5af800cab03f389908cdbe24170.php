            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <th><?php echo app('translator')->getFromJson('quickadmin.missions.fields.piece-jointe'); ?></th>
                        ...
                        <tr>
                            <th><?php echo app('translator')->getFromJson('quickadmin.missions.fields.itineraire'); ?></th>
                        ...
                        <tr>
                            <th><?php echo app('translator')->getFromJson('quickadmin.missions.fields.multiple-piece-jointe'); ?></th>
                        ...
                        <tr>
                            <th><?php echo app('translator')->getFromJson('quickadmin.missions.fields.latitude'); ?></th>
                            <td field-key='latitude'><?php echo e($mission->latitude); ?></td>
                        </tr>
                        <tr>
                            <th><?php echo app('translator')->getFromJson('quickadmin.missions.fields.longitude'); ?></th>
