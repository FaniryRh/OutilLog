        ...
        <ul class="sidebar-menu bg-white">
            ...
            <li class="treeview">
                <a href="#">
                    ...
                    <span class="title">Gestion utilisateur</span>
            ...
            <?php endif; ?>
            <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('reunion_access')): ?>
            <li class="<?php echo e($request->segment(2) == 'reunions' ? 'active' : ''); ?>">
                <a href="<?php echo e(route('admin.reunions.index')); ?>">
                    <i class="fa fa-television"></i>
                    <span class="title"><?php echo app('translator')->getFromJson('quickadmin.reunion.title'); ?></span>
                </a>
            </li>
            <?php endif; ?> -->
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                   <li class="<?php echo e($request->is('/reports/taches')); ?>">
                        <a href="<?php echo e(url('/admin/reports/taches')); ?>">
                            <i class="fa fa-line-chart"></i>
                            <span class="title">Tâches</span>
                        </a>
                    </li>   <li class="<?php echo e($request->is('/reports/reunion')); ?>">
                        <a href="<?php echo e(url('/admin/reports/reunion')); ?>">
                            <i class="fa fa-line-chart"></i>
                            <span class="title">Réunion</span>
                        </a>
                    </li>   <li class="<?php echo e($request->is('/reports/mission')); ?>">
                        <a href="<?php echo e(url('/admin/reports/mission')); ?>">
                            <i class="fa fa-line-chart"></i>
