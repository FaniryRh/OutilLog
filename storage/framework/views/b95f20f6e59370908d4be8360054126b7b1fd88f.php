...
<style>
    ...
    <h3 class="page-title"><!-- <?php echo app('translator')->getFromJson('quickadmin.missions.title'); ?> --><?php echo e($mission->objet); ?></h3>
                ...
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            ...
                            <td field-key='objet' style="width: 100%;"><?php echo e($mission->objet); ?></td>
                        </tr>
                        <tr>
                            ...
                            <td field-key='location' style="width: 100%;"><?php echo e($mission->location); ?></td>
                        </tr>
                        <tr>
                            ...
                            <td field-key='date_deb' style="width: 100%;"><?php echo e($mission->date_deb); ?></td>
                        </tr>
                        <tr>
                            ...
                            <td field-key='date_fin' style="width: 100%;"><?php echo e($mission->date_fin); ?></td>
                        </tr>
                        <tr>
                            ...
                            <td field-key='piece_jointe' style="width: 100%;"><?php if($mission->piece_jointe): ?><a href="<?php echo e(asset(env('UPLOAD_PATH').'/' . $mission->piece_jointe)); ?>" target="_blank">Download file</a><?php endif; ?></td>
                        </tr>
                        <tr>
                            ...
                            <td field-key='description' style="width: 100%;"><?php echo $mission->description; ?></td>
                        </tr>
                        <tr>
                            ...
                            <td field-key='itineraire' style="width: 100%;"><?php if($mission->itineraire): ?><a href="<?php echo e(asset(env('UPLOAD_PATH').'/' . $mission->itineraire)); ?>" target="_blank"><img src="<?php echo e(asset(env('UPLOAD_PATH').'/thumb/' . $mission->itineraire)); ?>"/></a><?php endif; ?></td>
                        </tr>
                        <tr>
                            ...
                            <td field-key='personnel_id' style="width: 100%;">
                                <?php $__currentLoopData = $mission->personnel_id; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $singlePersonnelId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="label label-info label-many"><a style="color: white;" href="<?php echo e(route('admin.personnel_du_bngrcs.show',[$singlePersonnelId->id])); ?>"><?php echo e($singlePersonnelId->nom_prenom); ?></a></span>
                        ...
                        <tr>
                            ...
                            <td field-key='stat' style="width: 100%;"><?php echo e(isset($mission->stat->name) ? $mission->stat->name : ''); ?></td>
                        </tr>
                        ...
                        <tr style="display: none;">
                            <th style="background-color:grey; display: none; width: 200px; color: white;"><?php echo app('translator')->getFromJson('quickadmin.missions.fields.longitude'); ?></th>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('mission_edit')): ?>
                          <a href="<?php echo e(route('admin.missions.edit',[$mission->id])); ?>" class="btn btn-info fa fa-edit"> <?php echo app('translator')->getFromJson('quickadmin.qa_edit'); ?></a>
                    <?php endif; ?>

                          <a href="<?php echo e(route('admin.google_map_missions.index')); ?>" class="btn btn-default fa fa-globe"> Carte globale</a>
...
<table class="table table-bordered table-striped <?php echo e(count($tasks) > 0 ? 'datatable' : ''); ?>">
    <thead style="background-color: orange;">
        <tr>
                        ...
                        <th style="width: 20px;"><?php echo app('translator')->getFromJson('quickadmin.tasks.fields.name'); ?></th>
                ...
                <tr data-entry-id="<?php echo e($inventaire->id); ?>">
                    <td field-key='date'><?php echo e($inventaire->date); ?></td>
                                ...
                                <td field-key='destination'><?php echo e($inventaire->destination); ?></td>
                                    ...
                                    <a href="<?php echo e(route('admin.inventaires.show',[$inventaire->id])); ?>" class="btn btn-xs btn-primary fa fa-eye"> <?php echo app('translator')->getFromJson('quickadmin.qa_view'); ?></a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventaire_edit')): ?>
                                    <a href="<?php echo e(route('admin.inventaires.edit',[$inventaire->id])); ?>" class="btn btn-xs btn-info fa fa-edit"> <?php echo app('translator')->getFromJson('quickadmin.qa_edit'); ?></a>
                                    <?php endif; ?>
...
<table class="table table-bordered table-striped <?php echo e(count($sorties) > 0 ? 'datatable' : ''); ?>">
    <thead style="background-color: orange;">
        <tr>
            <th style="width: 20px;"><?php echo app('translator')->getFromJson('quickadmin.sortie.fields.parsonnel'); ?></th>
        ...
        <?php if(count($sorties) > 0): ?>
            <?php $__currentLoopData = $sorties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sorty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr data-entry-id="<?php echo e($sorty->id); ?>">
                                <td field-key='parsonnel'><a href="<?php echo e(route('admin.personnel_du_bngrcs.show',[$sorty->parsonnel->id])); ?>"><?php echo e(isset($sorty->parsonnel->nom_prenom) ? $sorty->parsonnel->nom_prenom : ''); ?></a></td>
                                <td field-key='stock'><a href="<?php echo e(route('admin.liste_stocks.show',[$sorty->stock->id])); ?>"><?php echo e(isset($sorty->stock->designation) ? $sorty->stock->designation : ''); ?></a></td>
