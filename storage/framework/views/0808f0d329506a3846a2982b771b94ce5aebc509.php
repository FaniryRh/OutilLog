...
<?php $__env->startSection('content'); ?>
    ...
    <p>
        <a href="<?php echo e(route('admin.contact_companies.create')); ?>" class="btn btn-success fa fa-plus"><!-- <?php echo app('translator')->getFromJson('quickadmin.qa_add_new'); ?> --> Nouvelle Organisme</a>
                    ...
                    <?php if(count($contact_companies) > 0): ?>
                        <?php $__currentLoopData = $contact_companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact_company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-entry-id="<?php echo e($contact_company->id); ?>">
                                ...
                                <td field-key='name' style="background-color: #ffeecc; font-weight: bold;"><?php echo e($contact_company->name); ?></td>
                                ...
                                <td field-key='tel'><?php echo e($contact_company->tel); ?></td>
                                    ...
                                    <a href="<?php echo e(route('admin.contact_companies.show',[$contact_company->id])); ?>" class="btn btn-xs btn-primary fa fa-eye"> <?php echo app('translator')->getFromJson('quickadmin.qa_view'); ?></a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contact_company_edit')): ?>
                                    <a href="<?php echo e(route('admin.contact_companies.edit',[$contact_company->id])); ?>" class="btn btn-xs btn-info fa fa-edit"> <?php echo app('translator')->getFromJson('quickadmin.qa_edit'); ?></a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contact_company_delete')): ?>
