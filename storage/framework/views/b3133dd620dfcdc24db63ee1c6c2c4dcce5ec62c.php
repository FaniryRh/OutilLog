                ...
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td field-key='website'><a href="<?php echo e($contact_company->website); ?>"><?php echo e($contact_company->website); ?></a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td field-key='tel'><?php echo e($contact_company->tel); ?></td>
                                ...
                                <a href="<?php echo e(route('admin.contact_companies.index')); ?>" class="btn btn-default fa fa-arrow-circle-left"> <?php echo app('translator')->getFromJson('quickadmin.qa_back_to_list'); ?></a>

                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contact_company_edit')): ?>
                                    <a href="<?php echo e(route('admin.contact_companies.edit',[$contact_company->id])); ?>" class="btn btn-info fa fa-edit"> <?php echo app('translator')->getFromJson('quickadmin.qa_edit'); ?></a>
                                <?php endif; ?>
                ...
                <tr data-entry-id="<?php echo e($contact_district->id); ?>">
                    <td field-key='nom_prenom'><?php echo e($contact_district->nom_prenom); ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('admin.contact_districts.show',[$contact_district->id])); ?>" class="btn btn-xs btn-primary fa fa-eye"> <?php echo app('translator')->getFromJson('quickadmin.qa_view'); ?></a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contact_district_edit')): ?>
                                    <a href="<?php echo e(route('admin.contact_districts.edit',[$contact_district->id])); ?>" class="btn btn-xs btn-info fa fa-edit"> <?php echo app('translator')->getFromJson('quickadmin.qa_edit'); ?></a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contact_district_delete')): ?>
<?php echo Form::open(array(
                                        'style' => 'display: inline-block;',
                ...
                <tr data-entry-id="<?php echo e($contacts_region->id); ?>">
                    <td field-key='nom_prenom'><?php echo e($contacts_region->nom_prenom); ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('admin.contacts_regions.show',[$contacts_region->id])); ?>" class="btn btn-xs btn-primary fa fa-eye"> <?php echo app('translator')->getFromJson('quickadmin.qa_view'); ?></a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contacts_region_edit')): ?>
                                    <a href="<?php echo e(route('admin.contacts_regions.edit',[$contacts_region->id])); ?>" class="btn btn-xs btn-info fa fa-edit"> <?php echo app('translator')->getFromJson('quickadmin.qa_edit'); ?></a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contacts_region_delete')): ?>
<?php echo Form::open(array(
                                        'style' => 'display: inline-block;',
                ...
                <tr data-entry-id="<?php echo e($liste_groupe_sectoriel->id); ?>">
                    <td field-key='nom_prenom'><?php echo e($liste_groupe_sectoriel->nom_prenom); ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('admin.liste_groupe_sectoriels.show',[$liste_groupe_sectoriel->id])); ?>" class="btn btn-xs btn-primary fa fa-eye"> <?php echo app('translator')->getFromJson('quickadmin.qa_view'); ?></a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('liste_groupe_sectoriel_edit')): ?>
                                    <a href="<?php echo e(route('admin.liste_groupe_sectoriels.edit',[$liste_groupe_sectoriel->id])); ?>" class="btn btn-xs btn-info fa fa-edit"> <?php echo app('translator')->getFromJson('quickadmin.qa_edit'); ?></a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('liste_groupe_sectoriel_delete')): ?>
<?php echo Form::open(array(
                                        'style' => 'display: inline-block;',
