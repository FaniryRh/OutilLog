            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;"><?php echo app('translator')->getFromJson('quickadmin.assets.fields.photo1'); ?></th>
                        ...
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;"><?php echo app('translator')->getFromJson('quickadmin.assets.fields.photo2'); ?></th>
                        ...
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;"><?php echo app('translator')->getFromJson('quickadmin.assets.fields.photo3'); ?></th>
                        ...
                        <tr style="display: none;">
                            <th style="background-color:grey; width: 200px; color: white;"><?php echo app('translator')->getFromJson('quickadmin.assets.fields.latitude'); ?></th>
                            <td field-key='latitude'><?php echo e($asset->latitude); ?></td>
                        </tr>
                        <tr style="display: none;">
                            <th style="background-color:grey; width: 200px; color: white;"><?php echo app('translator')->getFromJson('quickadmin.assets.fields.longitude'); ?></th>
...
<li role="presentation" class="active"><a href="#inventaire" aria-controls="inventaire" role="tab" data-toggle="tab">Inventaire</a></li>
...
<div role="tabpanel" class="tab-pane active " id="inventaire">
