                ...
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td field-key='stock'><a href="<?php echo e(route('admin.liste_stocks.show',[$sortie->stock->id])); ?>"><?php echo e(isset($sortie->stock->designation) ? $sortie->stock->designation : ''); ?></a></td>
                        </tr>
                        <tr>
