<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::model($task, ['method' => 'PUT', 'route' => ['admin.tasks.update', $task->id], 'files' => true,]); ?>


    <div class="panel panel-primary">
        <div class="panel-heading">
            <!-- <?php echo app('translator')->getFromJson('quickadmin.qa_edit'); ?> --> Modifier
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::select('organisme[]', $organismes, old('organisme') ? old('organisme') : $task->organisme->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']); ?>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <?php if($task->attachment): ?>
                        <a href="<?php echo e(asset(env('UPLOAD_PATH').'/' . $task->attachment)); ?>" target="_blank">Download file</a>
                    <?php endif; ?>
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    <?php echo Form::label('due_date', 'Date d\'échéance', ['class' => 'control-label']); ?>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::select('participant[]', $participants, old('participant') ? old('participant') : $task->participant->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']); ?>
