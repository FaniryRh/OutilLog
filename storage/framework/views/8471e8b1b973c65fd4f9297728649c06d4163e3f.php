<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <!-- <?php echo app('translator')->getFromJson('quickadmin.qa_create'); ?> -->Ajout Mission
        </div>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::text('objet', 'Survole Fianarantsoa', ['class' => 'form-control', 'placeholder' => '']); ?>
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <?php echo Form::text('location', 'Fianarantsoa', ['class' => 'form-control', 'placeholder' => '']); ?>
            ...
            <div class="row" style="display: none;">
                <div class="col-xs-12 form-group">
                    ...
                    <?php echo Form::text('latitude', '-18.915647', ['id' => 'lat','class' => 'form-control']); ?>
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <?php echo Form::text('longitude', '47.540394', ['id' => 'lng','class' => 'form-control']); ?>
    ...
    <!-- <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="sortie">
                    <?php $__currentLoopData = old('sorties', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php echo Form::submit('Enregistrer', ['class' => 'btn btn-danger']); ?>
