...
<?php $__env->startSection('content'); ?>
    ...
    <p>
        <a href="<?php echo e(route('admin.assets.create')); ?>" class="btn btn-success">Ajouter nouveau matériel</a>
                    ...
                    <?php if(count($assets) > 0): ?>
                        <?php $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-entry-id="<?php echo e($asset->id); ?>">
                                ...
                                <td field-key='title' style="color: red; font-style: bolder;"><?php echo e($asset->title); ?></td>
