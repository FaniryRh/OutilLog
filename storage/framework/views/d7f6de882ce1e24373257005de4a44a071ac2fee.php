...
<?php $__env->startSection('content'); ?>
    <h3 class="page-title"><!-- <?php echo app('translator')->getFromJson('quickadmin.users.title'); ?> -->Utilisateurs</h3>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user_create')): ?>
    <p>
        <a href="<?php echo e(route('admin.users.create')); ?>" class="btn btn-success"><!-- <?php echo app('translator')->getFromJson('quickadmin.qa_add_new'); ?> -->Nouveau utilisateur</a>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            Liste<!-- <?php echo app('translator')->getFromJson('quickadmin.qa_list'); ?> -->
        </div>
