<?php $__env->startSection('content'); ?>
    <h3 class="page-title"><!-- <?php echo app('translator')->getFromJson('quickadmin.entree.title'); ?> -->Modification</h3>
    
    <?php echo Form::model($entree, ['method' => 'PUT', 'route' => ['admin.entrees.update', $entree->id]]); ?>


    <div class="panel panel-primary">
        <div class="panel-heading" style="text-transform: uppercase;">
            <?php echo $entree->stock->designation; ?>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    <?php echo Form::label('date', trans('quickadmin.entree.fields.date').'*', ['class' => 'control-label']); ?>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    <?php echo Form::label('stock_id', trans('quickadmin.entree.fields.stock').'*', ['class' => 'control-label']); ?>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    <?php echo Form::label('quantite', trans('quickadmin.entree.fields.quantite').'*', ['class' => 'control-label']); ?>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    <?php echo Form::label('unite', trans('quickadmin.entree.fields.unite').'', ['class' => 'control-label']); ?>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    <?php echo Form::label('motif', trans('quickadmin.entree.fields.motif').'', ['class' => 'control-label']); ?>
