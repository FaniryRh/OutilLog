    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('statut_personnel_access')): ?>
                <li class="<?php echo e($request->segment(2) == 'statut_personnels' ? 'active active-sub' : ''); ?>">
                        <a href="<?php echo e(route('admin.statut_personnels.index')); ?>">
                            <i class="fa fa-folder"></i>
                            <span class="title">
                                <?php echo app('translator')->getFromJson('quickadmin.statut-personnel.title'); ?>
                            </span>
                        </a>
                    </li>
                <?php endif; ?>
            ...
            <li class="treeview">
                ...
                <?php endif; ?>
                <!-- <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('status_sortie_access')): ?>
                <li class="<?php echo e($request->segment(2) == 'status_sorties' ? 'active active-sub' : ''); ?>">
                        <a href="<?php echo e(route('admin.status_sorties.index')); ?>">
                            <i class="fa fa-folder"></i>
                            <span class="title">
                                <?php echo app('translator')->getFromJson('quickadmin.status-sortie.title'); ?>
                            </span>
                        </a>
                    </li>
                <?php endif; ?> -->
