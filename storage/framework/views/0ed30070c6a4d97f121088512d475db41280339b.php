<?php $__env->startSection('content'); ?>
    ...
    <?php echo Form::model($capacite, ['method' => 'PUT', 'route' => ['admin.capacites.update', $capacite->id], 'files' => true,]); ?>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <?php if($capacite->piece_jointe): ?>
                        <a href="<?php echo e(asset(env('UPLOAD_PATH').'/' . $capacite->piece_jointe)); ?>" target="_blank">Download file</a>
                    <?php endif; ?>
    ...
    <a href="<?php echo e(route('admin.capacites.index')); ?>" class="btn btn-default fa fa-arrow-circle-left"><?php echo app('translator')->getFromJson('quickadmin.qa_back_to_list'); ?></a>
