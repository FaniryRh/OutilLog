    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-6 form-group">
                    <?php echo Form::label('asset_id', trans('quickadmin.inventaire.fields.asset').'', ['class' => 'control-label']); ?>

                    <?php echo Form::select('asset_id', $assets, old('asset_id'), ['class' => 'form-control select2']); ?>

                    <p class="help-block"></p>
                    <?php if($errors->has('asset_id')): ?>
                        <p class="help-block">
                            <?php echo e($errors->first('asset_id')); ?>
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    <?php echo Form::label('nombre', trans('quickadmin.inventaire.fields.nombre').'', ['class' => 'control-label']); ?>

                    <?php echo Form::number('nombre', old('nombre'), ['class' => 'form-control', 'placeholder' => '']); ?>
