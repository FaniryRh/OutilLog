...
<style>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="" style="visibility: hidden; width: 1px; height: 1px; display: none;">
                ...
                <div class="" style="visibility: hidden; width: 1px; height: 1px;">
                    ...
                    <?php echo Form::label('multiple_piece_jointe', trans('quickadmin.missions.fields.multiple-piece-jointe').'', ['class' => ''], ['style' => ' width: 1px; height: 1px;']); ?>
                    ...
                    <p class=""></p>
                    <div class="" style="visibility: hidden; width: 1px; height: 1px;">
                        <div class="progress-bar form-group" style="visibility: hidden; width: 1px; height: 1px;">&nbsp;</div>
                        <div class="files-list" style="visibility: hidden; width: 1px; height: 1px;"></div>
                    </div>
