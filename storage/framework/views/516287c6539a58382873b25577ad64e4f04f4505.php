<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body table-responsive">
            ...
            <a href="<?php echo e(route('admin.absences.index')); ?>" class="btn btn-default fa fa-arrow-circle-left"><?php echo app('translator')->getFromJson('quickadmin.qa_back_to_list'); ?></a>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('absence_edit')): ?>
                      <a href="<?php echo e(route('admin.absences.edit',[$absence->id])); ?>" class="btn btn-info fa fa-edit"><?php echo app('translator')->getFromJson('quickadmin.qa_edit'); ?></a>
            <?php endif; ?>
        </div>
    </div>
