<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <!-- <?php echo app('translator')->getFromJson('quickadmin.qa_view'); ?> --><?php echo e($competance_formation->titre); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;"><?php echo app('translator')->getFromJson('quickadmin.competance-formation.fields.titre'); ?></th>
                            <td field-key='titre'><?php echo e($competance_formation->titre); ?></td>
                        </tr>
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;"><?php echo app('translator')->getFromJson('quickadmin.competance-formation.fields.description'); ?></th>
                            <td field-key='description'><?php echo $competance_formation->description; ?></td>
                        </tr>
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;"><?php echo app('translator')->getFromJson('quickadmin.competance-formation.fields.piece-jointe'); ?></th>
...
<?php echo Form::open(array(
        ...
        <?php endif; ?>
            ...
            <a href="<?php echo e(route('admin.competance_formations.index')); ?>" class="btn btn-default"><?php echo app('translator')->getFromJson('quickadmin.qa_back_to_list'); ?></a>
        </div>
    </div>
