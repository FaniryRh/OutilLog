...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.oms.store'], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::select('prise_en_charge[]', $prise_en_charges, old('prise_en_charge'), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    {!! Form::label('etat_id', trans('Statut OM').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                ...
                <div class="col-xs-6 form-group">
                    {!! Form::label('etat_rapport_de_mission_id', trans('Statut rapport').'', ['class' => 'control-label']) !!}
