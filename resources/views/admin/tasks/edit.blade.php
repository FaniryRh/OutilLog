        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::select('organisme[]', $organismes, old('organisme') ? old('organisme') : $task->organisme->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-6 form-group" style="display: none;">
                    ...
                    {!! Form::select('status_id', $statuses, old('status_id'), ['class' => 'form-control select2', 'required' => '', 'readonly']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    {!! Form::label('due_date', trans('Date').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                ...
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::select('participant[]', $participants, old('participant') ? old('participant') : $task->participant->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
