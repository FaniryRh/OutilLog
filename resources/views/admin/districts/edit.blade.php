...
@section('content')
    ...
    {!! Form::model($district, ['method' => 'PUT', 'route' => ['admin.districts.update', $district->id]]) !!}
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="contacts-district">
                    @forelse(old('contact_districts', []) as $index => $data)
                        @include('admin.districts.contact_districts_row', [
                            'index' => $index
                        ])
                    @empty
                        @foreach($district->contactDistrict as $item)
                            @include('admin.districts.contact_districts_row', [
                                'index' => 'id-' . $item->id,
                                'field' => $item
                            ])
