...
@section('content')
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <!-- @lang('quickadmin.qa_create') -->Ajout Mission
        </div>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('objet', 'Survole Fianarantsoa', ['class' => 'form-control', 'placeholder' => '']) !!}
                ...
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::text('location', 'Fianarantsoa', ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                ...
                <div class="col-xs-6 form-group" style="display: none;">
                    ...
                    {!! Form::text('progression', '0', ['class' => 'form-control', 'placeholder' => '', 'readonly']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row" style="display: none;">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('latitude', '-18.915647', ['id' => 'lat','class' => 'form-control']) !!}
                    <p class="help-block"></p>
                ...
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('longitude', '47.540394', ['id' => 'lng','class' => 'form-control']) !!}
                    <p class="help-block"></p>
    ...
    <!-- <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped">
                ...
                <tbody id="sortie">
                    @foreach(old('sorties', []) as $index => $data)
