...
@section('content')
    ...
    {!! Form::model($liste_stock, ['method' => 'PUT', 'route' => ['admin.liste_stocks.update', $liste_stock->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($liste_stock->photo)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$liste_stock->photo) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$liste_stock->photo) }}"></a>
                    @endif
