...
@section('content')
    ...
    @can('absence_create')
    <p>
        <a href="{{ route('admin.absences.create') }}" class="btn btn-success fa fa-plus"> @lang('quickadmin.qa_add_new')</a>
                        ...
                        @foreach ($absences as $absence)
                            <tr data-entry-id="{{ $absence->id }}">
                                ...
                                <td field-key='motif'>{!! $absence->motif !!}</td>
                                                                <td>
                                    @can('absence_view')
                                    <a href="{{ route('admin.absences.show',[$absence->id]) }}" class="btn btn-xs btn-primary fa fa-eye"> @lang('quickadmin.qa_view')</a>
                                    @endcan
                                    @can('absence_edit')
                                    <a href="{{ route('admin.absences.edit',[$absence->id]) }}" class="btn btn-xs btn-info fa fa-edit"> @lang('quickadmin.qa_edit')</a>
                                    @endcan
                                    @can('absence_delete')
{!! Form::open(array(
