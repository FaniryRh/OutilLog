...
@section('content')
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <!-- @lang('quickadmin.qa_view') -->{{ $contact_company->name }}
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;">@lang('quickadmin.contact-companies.fields.logo')</th>
                        ...
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;">@lang('quickadmin.contact-companies.fields.name')</th>
                            <td field-key='name'>{{ $contact_company->name }}</td>
                        </tr>
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;">@lang('quickadmin.contact-companies.fields.address')</th>
                            <td field-key='address'>{{ $contact_company->address }}</td>
                        </tr>
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;">@lang('quickadmin.contact-companies.fields.website')</th>
                            <td field-key='website'><a href="{{ $contact_company->website }}">{{ $contact_company->website }}</a></td>
                        </tr>
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;">@lang('quickadmin.contact-companies.fields.email')</th>
                            <td field-key='email'>{{ $contact_company->email }}</td>
                        </tr>
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;">@lang('quickadmin.contact-companies.fields.tel')</th>
                            <td field-key='tel'>{{ $contact_company->tel }}</td>
                                ...
                                @can('contact_company_edit')
                                    <a href="{{ route('admin.contact_companies.edit',[$contact_company->id]) }}" class="btn btn-info fa fa-edit"> @lang('quickadmin.qa_edit')</a>
                                @endcan
                ...
                <tr data-entry-id="{{ $contact_district->id }}">
                    <td field-key='nom_prenom'>{{ $contact_district->nom_prenom }}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.contact_districts.show',[$contact_district->id]) }}" class="btn btn-xs btn-primary fa fa-eye"> @lang('quickadmin.qa_view')</a>
                                    @endcan
                                    @can('contact_district_edit')
                                    <a href="{{ route('admin.contact_districts.edit',[$contact_district->id]) }}" class="btn btn-xs btn-info fa fa-edit"> @lang('quickadmin.qa_edit')</a>
                                    @endcan
                                    @can('contact_district_delete')
{!! Form::open(array(
                                        'style' => 'display: inline-block;',
                ...
                <tr data-entry-id="{{ $contacts_region->id }}">
                    <td field-key='nom_prenom'>{{ $contacts_region->nom_prenom }}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.contacts_regions.show',[$contacts_region->id]) }}" class="btn btn-xs btn-primary fa fa-eye"> @lang('quickadmin.qa_view')</a>
                                    @endcan
                                    @can('contacts_region_edit')
                                    <a href="{{ route('admin.contacts_regions.edit',[$contacts_region->id]) }}" class="btn btn-xs btn-info fa fa-edit"> @lang('quickadmin.qa_edit')</a>
                                    @endcan
                                    @can('contacts_region_delete')
{!! Form::open(array(
                                        'style' => 'display: inline-block;',
                ...
                <tr data-entry-id="{{ $liste_groupe_sectoriel->id }}">
                    <td field-key='nom_prenom'>{{ $liste_groupe_sectoriel->nom_prenom }}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin.liste_groupe_sectoriels.show',[$liste_groupe_sectoriel->id]) }}" class="btn btn-xs btn-primary fa fa-eye"> @lang('quickadmin.qa_view')</a>
                                    @endcan
                                    @can('liste_groupe_sectoriel_edit')
                                    <a href="{{ route('admin.liste_groupe_sectoriels.edit',[$liste_groupe_sectoriel->id]) }}" class="btn btn-xs btn-info fa fa-edit"> @lang('quickadmin.qa_edit')</a>
                                    @endcan
                                    @can('liste_groupe_sectoriel_delete')
{!! Form::open(array(
                                        'style' => 'display: inline-block;',
