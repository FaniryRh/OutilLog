...
<style>
    ...
    {!! Form::model($personnel_du_bngrc, ['method' => 'PUT', 'route' => ['admin.personnel_du_bngrcs.update', $personnel_du_bngrc->id], 'files' => true,]) !!}

    <div class="panel panel-primary">
        <div class="panel-heading">
            <!-- @lang('quickadmin.qa_edit') -->Modification
        </div>

        <div class="panel-body">
            <div class="row">
                <div class="col-xs-6 form-group">
                    @if ($personnel_du_bngrc->photo)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$personnel_du_bngrc->photo) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$personnel_du_bngrc->photo) }}"></a>
                    @endif
            ...
            <div class="row">
                ...
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::select('competence_formation[]', $competence_formations, old('competence_formation') ? old('competence_formation') : $personnel_du_bngrc->competence_formation->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    {!! Form::select('capacites[]', $capacites, old('capacites') ? old('capacites') : $personnel_du_bngrc->capacites->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
