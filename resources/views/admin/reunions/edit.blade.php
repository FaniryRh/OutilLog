...
@section('content')
    ...
    {!! Form::model($reunion, ['method' => 'PUT', 'route' => ['admin.reunions.update', $reunion->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('organisme_id[]', $organisme_ids, old('organisme_id') ? old('organisme_id') : $reunion->organisme_id->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('participant_bngrc[]', $participant_bngrcs, old('participant_bngrc') ? old('participant_bngrc') : $reunion->participant_bngrc->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    @if ($reunion->rapport)
                        <a href="{{ asset(env('UPLOAD_PATH').'/' . $reunion->rapport) }}" target="_blank">Download file</a>
                    @endif
