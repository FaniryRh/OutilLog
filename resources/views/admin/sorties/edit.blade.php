...
@section('content')
    ...
    {!! Form::model($sortie, ['method' => 'PUT', 'route' => ['admin.sorties.update', $sortie->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::hidden('location_latitude', $sortie->location_latitude , ['id' => 'location-latitude']) !!}
                    {!! Form::hidden('location_longitude', $sortie->location_longitude , ['id' => 'location-longitude']) !!}
                    <p class="help-block"></p>
