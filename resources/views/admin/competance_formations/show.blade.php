...
@section('content')
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <!-- @lang('quickadmin.qa_view') -->{{ $competance_formation->titre }}
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;">@lang('quickadmin.competance-formation.fields.titre')</th>
                            <td field-key='titre'>{{ $competance_formation->titre }}</td>
                        </tr>
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;">@lang('quickadmin.competance-formation.fields.description')</th>
                            <td field-key='description'>{!! $competance_formation->description !!}</td>
                        </tr>
                        <tr>
                            <th style="background-color:grey; width: 200px; color: white;">@lang('quickadmin.competance-formation.fields.piece-jointe')</th>
