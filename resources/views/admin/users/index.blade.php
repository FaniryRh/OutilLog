...
@section('content')
    <h3 class="page-title"><!-- @lang('quickadmin.users.title') -->Utilisateurs</h3>
    @can('user_create')
    <p>
        <a href="{{ route('admin.users.create') }}" class="btn btn-success"><!-- @lang('quickadmin.qa_add_new') -->Nouveau utilisateur</a>
