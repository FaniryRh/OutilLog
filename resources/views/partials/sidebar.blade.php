    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                @endcan
                @can('statut_personnel_access')
                <li class="{{ $request->segment(2) == 'statut_personnels' ? 'active active-sub' : '' }}">
                        <a href="{{ route('admin.statut_personnels.index') }}">
                            <i class="fa fa-folder"></i>
                            <span class="title">
                                @lang('quickadmin.statut-personnel.title')
                            </span>
                        </a>
                    </li>
                @endcan
            ...
            <li class="treeview">
                ...
                @endcan
                <!-- @can('status_sortie_access')
                <li class="{{ $request->segment(2) == 'status_sorties' ? 'active active-sub' : '' }}">
                        <a href="{{ route('admin.status_sorties.index') }}">
                            <i class="fa fa-folder"></i>
                            <span class="title">
                                @lang('quickadmin.status-sortie.title')
                            </span>
                        </a>
                    </li>
                @endcan -->
