...
class AssetsController extends Controller
{
    ...
    public function create()
    {
        ...
        $assigned_users = \App\PersonnelDuBngrc::get()->pluck('nom_prenom', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
    ...
    public function show($id)
    {
        ...
        $statuses = \App\AssetsStatus::get()->pluck('title', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
        $locations = \App\AssetsLocation::get()->pluck('title', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
        $assigned_users = \App\PersonnelDuBngrc::get()->pluck('nom_prenom', 'id')->prepend(trans('quickadmin.qa_please_select'), '');$assets_histories = \App\AssetsHistory::where('asset_id', $id)->get();$inventaires = \App\Inventaire::whereHas('materiel_id',
                    function ($query) use ($id) {
                        $query->where('id', $id);
                    })->get();$missions = \App\Mission::whereHas('materiel_id',
                    function ($query) use ($id) {
                        $query->where('id', $id);
                    })->get();
        ...
        return view('admin.assets.show', compact('asset', 'assets_histories', 'inventaires', 'missions'));
    }
