...
class PersonnelDuBngrcsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.personnel_du_bngrcs.create', compact('competence_formations', 'capacites'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.personnel_du_bngrcs.edit', compact('personnel_du_bngrc', 'competence_formations', 'capacites'));
    }
    ...
    public function show($id)
    {
        ...
        $capacites = \App\Capacite::get()->pluck('titre', 'id');
$absences = \App\Absence::where('personnel_id', $id)->get();$oms = \App\Om::where('ordonnee_a_id', $id)->get();$assets_histories = \App\AssetsHistory::where('assigned_user_id', $id)->get();$inventaires = \App\Inventaire::whereHas('responsable_id',
                    function ($query) use ($id) {
                        $query->where('id', $id);
                    })->get();$tasks = \App\Task::where('user_id', $id)->get();$missions = \App\Mission::whereHas('personnel_id',
                    function ($query) use ($id) {
                        $query->where('id', $id);
                    })->get();$tasks = \App\Task::whereHas('participant',
                    function ($query) use ($id) {
                        $query->where('id', $id);
        ...
        return view('admin.personnel_du_bngrcs.show', compact('personnel_du_bngrc', 'absences', 'oms', 'assets_histories', 'inventaires', 'tasks', 'missions', 'tasks', 'assets'));
    }
