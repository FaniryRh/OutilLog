...
@section('content')
    <h3 class="page-title">@lang('quickadmin.assets-statuses.title')</h3>
            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th>@lang('quickadmin.assets-statuses.fields.title')</th>
...
{!! Form::open(array(
        ...
        @endif
            ...
            <a href="{{ route('admin.assets_statuses.index') }}" class="btn btn-default">@lang('quickadmin.qa_back_to_list')</a>
        </div>
    </div>
@stop
