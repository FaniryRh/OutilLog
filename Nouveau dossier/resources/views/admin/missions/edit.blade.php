        ...
        <div class="panel-body">
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <div class="photo-block">
                        ...
                        <div class="files-list">
                            @foreach($mission->getMedia('multiple_piece_jointe') as $media)
                                <p class="form-group">
                                    <a href="{{ $media->getUrl() }}" target="_blank">{{ $media->name }} ({{ $media->size }} KB)</a>
                                    <a href="#" class="btn btn-xs btn-danger remove-file">Remove</a>
                                    <input type="hidden" name="multiple_piece_jointe_id[]" value="{{ $media->id }}">
                                </p>
                            @endforeach
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('materiel_id[]', $materiel_ids, old('materiel_id') ? old('materiel_id') : $mission->materiel_id->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple']) !!}
                    <p class="help-block"></p>
