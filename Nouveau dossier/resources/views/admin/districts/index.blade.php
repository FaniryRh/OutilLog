...
@section('content')
    ...
    @can('district_create')
    <p>
        <a href="{{ route('admin.districts.create') }}" class="btn btn-success">@lang('quickadmin.qa_add_new')</a>
            ...
            <table class="table table-bordered table-striped {{ count($districts) > 0 ? 'datatable' : '' }} @can('district_delete') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                <thead>
                    <tr>
                        ...
                        <th>@lang('quickadmin.district.fields.region')</th>
                    ...
                    @if (count($districts) > 0)
                        @foreach ($districts as $district)
                            <tr data-entry-id="{{ $district->id }}">
                                ...
                                <td field-key='region'>{{ $district->region->name or '' }}</td>
